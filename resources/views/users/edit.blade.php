...
<div class="form-wrapper">
    <div class="form-container">
        <div class="form-header">
            <h1>Edit Employee</h1>
            <p>Update employee information and roles</p>
        </div>
        ...
        <form method="POST" action="{{ route('users.update', $user->id) }}">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-input @error('name') error @enderror" value="{{ old('name', $user->name) }}">
                    @error('name')<span class="error-text">{{ $message }}</span>@enderror
                </div>

                <div class="form-group">
                    <label for="email" class="form-label">Email</label>
                    <input type="email" name="email" id="email" class="form-input @error('email') error @enderror" value="{{ old('email', $user->email) }}">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="confirm-password" id="confirm-password" class="form-input @error('confirm-password') error @enderror">
            ...
            <div class="form-group">
                ...
                <select name="roles[]" id="roles" class="form-input @error('roles') error @enderror" multiple>
