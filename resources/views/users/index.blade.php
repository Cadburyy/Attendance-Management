...
<style>
    ...
    .user-email { font-size: 14px; color: #6b7280; margin-bottom: 16px; word-break: break-all; }
    .role-badge { padding: 6px 14px; background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); color: white; border-radius: 20px; font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.3px; margin-bottom: 24px; display: inline-block; }
    .user-actions { margin-top: auto; padding-top: 10px; }
    .btn-action-icon { width: 40px; height: 40px; border-radius: 50%; border: 2px solid #e5e7eb; background: white; color: #0d3b66; display: inline-flex; align-items: center; justify-content: center; cursor: pointer; transition: all 0.3s ease; text-decoration: none; margin: 0 4px; }
    .btn-action-icon:hover { border-color: #0d3b66; background: #0d3b66; color: white; transform: translateY(-4px); box-shadow: 0 8px 16px rgba(13, 59, 102, 0.2); }
    .btn-action-icon.delete-btn:hover { border-color: #ef4444; background: #ef4444; }
    
    .alert-success-custom, .alert-error-custom { border-radius: 10px; padding: 16px 20px; margin-bottom: 24px; display: flex; align-items: center; gap: 12px; font-weight: 500; animation: slideIn 0.4s ease-out; }
    .alert-success-custom { background: linear-gradient(135deg, rgba(6, 168, 125, 0.1) 0%, rgba(6, 168, 125, 0.05) 100%); border-left: 4px solid #06a77d; color: #06a77d; }
    .alert-error-custom { background: linear-gradient(135deg, rgba(239, 68, 68, 0.1) 0%, rgba(239, 68, 68, 0.05) 100%); border-left: 4px solid #ef4444; color: #ef4444; }
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 16px;">
            ...
            <div class="modal-body">
                <p>Are you sure you want to delete this employee? This will also remove their encrypted AI face scan data.</p>
            </div>
